...
var self = module.exports = {
  __module: {
    properties: {
      log: 'grunt/log',
      config: 'config',
      contributeViewsSvc: 'svc|sequence!assetManager/contribute_views'
    },
    provides: {configure_task: {after: "grunt/tasks/*"}}
  },
  ...
  configureLinker: function(grunt, namespaces, taskName, startTag, endTag, fileTpl, extension, options) {
    ...
    _.each(namespaces, function(resources, namespace) {
      ...
      self.log.silly('particles-linker:'+taskName+'_'+namespace, configObj);
